...
const accentTextClass = computed(() => ({ presentation: 'text-[#b86b7a]', sales: 'text-[#0f7a3d]', booking: 'text-[#08738c]', ecommerce: 'text-[#805d2c]', 'custom-platform': 'text-[#5b4bb7]' }[theme.value] || 'text-[#805d2c]'))
