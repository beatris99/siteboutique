...
@section('title', __('site.city_rides.seo_title'))
@section('description', __('site.city_rides.seo_description'))

@section('content')

    <section id="city-offers" class="bg-gradient-to-br from-sky-50 via-white to-cyan-50 py-8 sm:py-12 md:py-16">
    ...
    <section class="bg-slate-50 py-10 sm:py-14 md:py-16">
        <div class="max-w-7xl mx-auto px-4">
            <h2 class="text-2xl sm:text-3xl font-bold tracking-tight text-slate-900">
                {{ __('site.city_rides.benefits_title') }}
            </h2>

            <div class="mt-6 grid md:grid-cols-3 gap-4 sm:gap-6">
                @foreach(__('site.city_rides.benefits') as $benefit)
