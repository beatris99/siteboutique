...
@php
    ...
    $leadSuccessContent = trans('lead_success');
    ...
    $sitegoAppData = [
        ...
        'content' => [
            ...
            'leadSuccess' => $leadSuccessContent,
        ],
    ...
    $metaByPath = [
        ...
        'cerere-trimisa' => [
            'title' => data_get($leadSuccessContent, 'meta.title'),

            'description' => data_get($leadSuccessContent, 'meta.description'),
        ],
...
<head>
    ...
    <link href="https://fonts.bunny.net/css?family=instrument-sans:400,500,600,700|source-serif-4:400,500,600,700"
        rel="stylesheet">
                    ...
                    [
                        ...
                        'areaServed' => [
                            ...
                            [
                                ...
                                'name' =>
                                    'Remote / international online collaboration',
                            ],
                        ],
